			...
			<div dir="rtl" class="col-lg-9 col-md-9 col-sm-12 col-xs-12 float-left p-3 bg-white border-15 shadow overflow-hidden">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 float-right">
					...
					<div class="" v-else>
						...
						>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 float-right p-1" v-for="(f, i) in date.data.flds[indexVal].times_class" :key="i">
								<btn
									textClass="w-100 yekan"
...
<script>
	...
	export default {
		...
		methods:{
			...
			// *********************************************************************
			setTime(time){
				this.val.id = this.date.data.flds[this.indexVal].id;
				this.val.price = this.date.data.flds[this.indexVal].price;
			...
			calendar(e){
				this.val.date = e;
				this.val.time = "";
				this.indexVal = this.date.data.date.findIndex(this.findIndexCalendar);
			},
			// *********************************************************************
