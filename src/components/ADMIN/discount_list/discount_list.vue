		...
		export default {
			...
			methods:{
				...
				loader(p=1, search='',THIS = this){
					...
					$.post(this.baseurl+"discount/list?search="+search+"&p="+p, { role: this.$localStorage.get("user").username.role, token: this.$localStorage.get("user") }, function(D){
